  ...
  <div class="hjapp">
    ...
    <div class="hj-box">
      <van-swipe :autoplay="3000" indicator-color="white" class="hj-box">
        <van-swipe-item v-for="item in hello" :key="item.id">
    ...
    <div class="hj-box-nav">
      <ul>
        <li
          class="iconfont iconjiaoyiliebiao"
          v-for="item in getlistCathome"
          :key="item.id"
        >{{item.desc}}</li>
        ...
        <div class="hj-pao-right">
          <div class="hj-num">
            ...
            <div class="hj-head-top">
              ...
              <span>
                <img
                  src="https://yanxuan.nosdn.127.net/a3a8b2d59bce415e253c8d8e23fc6589.png?imageView&thumbnail=200x200&quality=75"
                  alt
                />
              </span>
            </div>
...
export default {
  ...
  methods: {
    ...
    getworld() {
      request
        .get("https://www.littleemmayang.com/api/home/catelist")
        .then(res => {
          //  console.log(res);
          if (res.status === 0) {
    ...
    getnav() {
      request
        .get("https://www.littleemmayang.com/api/home/tagList")
        .then(res => {
          //  console.log(res);
          if (res.status === 0) {
    ...
    getall() {
      request
        .get("https://www.littleemmayang.com/api/home/catehotsell")
        .then(res => {
          //  console.log(res);
          if (res.status === 0) {
    ...
    getlist() {
      request
        .get("https://www.littleemmayang.com/api/home/popularlist")
        .then(res => {
          console.log(res);
          if (res.status === 0) {
    ...
    getheadlist() {
      request
        .get("https://www.littleemmayang.com/api/home/flashsale")
        .then(res => {
          //  console.log(res);
          if (res.status === 0) {
    ...
    getheadList() {
      request
        .get("https://www.littleemmayang.com/api/home/newitemlist")
        .then(res => {
          //  console.log(res);
          if (res.status === 0) {
    ...
    getnumcat() {
      request
        .get("https://www.littleemmayang.com/api/home/shoppingguide")
        .then(res => {
          //  console.log(res);
          if (res.status === 0) {
    ...
    getCatworld() {
      request
        .get("https://www.littleemmayang.com/api/home/top/catelist")
        .then(res => {
          //  console.log(res);
          if (res.status === 0) {
